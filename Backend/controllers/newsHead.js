...
const newsModel = require('../models/newsHeading')


module.exports.addNewsHead = async (req, res) => {
    try {
...
module.exports.getNewsHead= async (req, res) => {
    try {
...
module.exports.getAllNewsHead = async (req, res) => {
    try {
...
module.exports.editNewsHead = async (req, res) => {
    try {
...
module.exports.deleteNewsHead = async (req, res) => {
    try {
        const id = req.params.id
